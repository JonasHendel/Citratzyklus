		...
		<div className='textContainer'>
			...
			>
				...
				<p>
					...
					, 1{' '}
					<a
						href='https://de.wikipedia.org/wiki/Flavin-Adenin-Dinukleotid'
						target='_blank'
					>
						FADH2
					</a>{' '}
					und 1{' '}
					<a
						href='https://de.wikipedia.org/wiki/Guanosintriphosphat'
						target='_blank'
					>
						GTP
					</a>
					...
					<a
						href='https://de.wikipedia.org/wiki/Atmungskette'
						target='_blank'
					>
						Atmungskette
					</a>{' '}
					zur Gewinnung von Energie benötigt. Aus 3 NADH/H+ werden ca.
					7,5 ATP gewonnen, aus 1 FADH2 ca. 1.5 ATP. Zusätlich wird
					aus 1 GTP, 1 ATP (nicht in der Atmungskette). Dies
					resultiert in einer ungefähren Energiebilanz von 10 ATP pro
					Zyklus.
				</p>
			</motion.div>
			<motion.div
			...
			>
				...
				<p>
					...
					<a
						href='https://de.wikipedia.org/wiki/Aerobie'
						target='_blank'
					>
					...
					<a
						href='https://de.wikipedia.org/wiki/Exergone_und_endergone_Reaktion'
						target='_blank'
					>
						exergone
					</a>{' '}
					...
					Auch bei hoher{' '}
					<a
						href='https://de.wikipedia.org/wiki/Adenosintriphosphat'
						target='_blank'
					>
						ATP-Konzentration
					</a>{' '}
			...
			>
				...
				<p>
					...
					In der{' '}
					<a
						href='https://de.wikipedia.org/wiki/Glykolyse'
						target='_blank'
					>
						Glykolyse
					</a>{' '}
					...
					<a
						href='https://de.wikipedia.org/wiki/Pyruvatdehydrogenase-Komplex'
						target='_blank'
					>
					...
					<a
						href='https://de.wikipedia.org/wiki/Thioester'
						target='_blank'
					>
						Thiosterbindung
					</a>
					...
					<a
						href='https://de.wikipedia.org/wiki/Acetate'
						target='_blank'
					>
						Acetatrest
					</a>{' '}
					und dem{' '}
					<a
						href='https://de.wikipedia.org/wiki/Coenzym_A'
						target='_blank'
					>
						Coenzym A
					</a>
